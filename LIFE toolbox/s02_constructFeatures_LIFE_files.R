...
setwd("V:/Matin/R Codes/02 Mobility Signature Paper/LIFE toolbox/")
...
setwd("../../../../ARRC/Active_Studies/ANALYSIS_ONGOING/LIFE Main data/LIFE accelerometry - second data - 10_26_15/")
...
save(LIFE.df, file = "../Mobility Signature Dataset/d01_LIFE_072316.Rdata")
save(missingFiles.log, file = "../Mobility Signature Dataset/log01_missingFiles_072316.Rdata")
