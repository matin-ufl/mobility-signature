...
main.constructFeatures <- function(AC.1s, PID) {
     ...
     wearTimes <- find.wearTime.exludeOutlier(accelerometerData, PID = PID)
     ...
     output$axis1_proportion <- sum(wearTimes$axis1) / sum(wearTimes$VM)
     output$axis2_proportion <- sum(wearTimes$axis2) / sum(wearTimes$VM)
     output$axis3_proportion <- sum(wearTimes$axis3) / sum(wearTimes$VM)
     
     output$axis1_Activity_count_per_wear_time_avg <- mean(wearTimes$axis1)
     output$axis1_Activity_count_per_wear_time_std <- sd(wearTimes$axis1)
     output$axis2_Activity_count_per_wear_time_avg <- mean(wearTimes$axis2)
     output$axis2_Activity_count_per_wear_time_std <- sd(wearTimes$axis2)
     output$axis3_Activity_count_per_wear_time_avg <- mean(wearTimes$axis3)
     output$axis3_Activity_count_per_wear_time_std <- sd(wearTimes$axis3)
     output$VM_Activity_count_per_wear_time_avg <- mean(wearTimes$VM)
     output$VM_Activity_count_per_wear_time_std <- sd(wearTimes$VM)
     
     output$axis1_Total_number_of_bouts <- sum(wearTimes$axis1_numberOfBouts)
     output$axis2_Total_number_of_bouts <- sum(wearTimes$axis2_numberOfBouts)
     output$axis3_Total_number_of_bouts <- sum(wearTimes$axis3_numberOfBouts)
     output$VM_Total_number_of_bouts <- sum(wearTimes$VM_numberOfBouts)
     
     output$axis1_Activity_counts_per_minute_per_bout_avg <- mean(axis1_bouts$activityCount.per.minute)
     output$axis1_Activity_counts_per_minute_per_bout_std <- sd(axis1_bouts$activityCount.per.minute)
     output$axis2_Activity_counts_per_minute_per_bout_avg <- mean(axis2_bouts$activityCount.per.minute)
     output$axis2_Activity_counts_per_minute_per_bout_std <- sd(axis2_bouts$activityCount.per.minute)
     output$axis3_Activity_counts_per_minute_per_bout_avg <- mean(axis3_bouts$activityCount.per.minute)
     output$axis3_Activity_counts_per_minute_per_bout_std <- sd(axis3_bouts$activityCount.per.minute)
     output$VM_Activity_counts_per_minute_per_bout_avg <- mean(VM_bouts$activityCount.per.minute)
     output$VM_Activity_counts_per_minute_per_bout_std <- sd(VM_bouts$activityCount.per.minute)
     
     output$axis1_Bout_length_avg <- mean(axis1_bouts$duration.minute)
     output$axis1_Bout_length_std <- sd(axis1_bouts$duration.minute)
     output$axis2_Bout_length_avg <- mean(axis2_bouts$duration.minute)
     output$axis2_Bout_length_std <- sd(axis2_bouts$duration.minute)
     output$axis3_Bout_length_avg <- mean(axis3_bouts$duration.minute)
     output$axis3_Bout_length_std <- sd(axis3_bouts$duration.minute)
     output$VM_Bout_length_avg <- mean(VM_bouts$duration.minute)
     output$VM_Bout_length_std <- sd(VM_bouts$duration.minute)
     
     output$axis1_Gap_between_bouts_length_avg <- mean(axis1_gaps$duration.minute)
     output$axis1_Gap_between_bouts_length_std <- sd(axis1_gaps$duration.minute)
     output$axis2_Gap_between_bouts_length_avg <- mean(axis2_gaps$duration.minute)
     output$axis2_Gap_between_bouts_length_std <- sd(axis2_gaps$duration.minute)
     output$axis3_Gap_between_bouts_length_avg <- mean(axis3_gaps$duration.minute)
     output$axis3_Gap_between_bouts_length_std <- sd(axis3_gaps$duration.minute)
     output$VM_Gap_between_bouts_length_avg <- mean(VM_gaps$duration.minute)
     output$VM_Gap_between_bouts_length_std <- sd(VM_gaps$duration.minute)
     
     output$axis1_Number_of_bouts_per_wear_time_avg <- mean(wearTimes$axis1_numberOfBouts)
     output$axis1_Number_of_bouts_per_wear_time_std <- sd(wearTimes$axis1_numberOfBouts)
     output$axis2_Number_of_bouts_per_wear_time_avg <- mean(wearTimes$axis2_numberOfBouts)
     output$axis2_Number_of_bouts_per_wear_time_std <- sd(wearTimes$axis2_numberOfBouts)
     output$axis3_Number_of_bouts_per_wear_time_avg <- mean(wearTimes$axis3_numberOfBouts)
     output$axis3_Number_of_bouts_per_wear_time_std <- sd(wearTimes$axis3_numberOfBouts)
     output$VM_Number_of_bouts_per_wear_time_avg <- mean(wearTimes$VM_numberOfBouts)
     output$VM_Number_of_bouts_per_wear_time_std <- sd(wearTimes$VM_numberOfBouts)
     ...
     output$axis1_Counts_per_min_for_half_life <- median(axis1_bouts$avgActivityCount)
     output$axis1_Bucket_for_half_life <- ceiling(which.min(abs(axis1_bouts$avgActivityCount - output$axis1_Counts_per_min_for_half_life)) / 60)
     output$axis2_Counts_per_min_for_half_life <- median(axis2_bouts$avgActivityCount)
     output$axis2_Bucket_for_half_life <- ceiling(which.min(abs(axis2_bouts$avgActivityCount - output$axis2_Counts_per_min_for_half_life)) / 60)
     output$axis3_Counts_per_min_for_half_life <- median(axis1_bouts$avgActivityCount)
     output$axis3_Bucket_for_half_life <- ceiling(which.min(abs(axis3_bouts$avgActivityCount - output$axis3_Counts_per_min_for_half_life)) / 60)
     output$VM_Counts_per_min_for_half_life <- median(VM_bouts$avgActivityCount)
     output$VM_Bucket_for_half_life <- ceiling(which.min(abs(VM_bouts$avgActivityCount - output$VM_Counts_per_min_for_half_life)) / 60)
     
     output$number_of_activityPeriods_per_wear_time = nrow(activityPeriods) / output$Number_of_valid_wear_times
     output$activityPeriods_duration_avg = mean(activityPeriods$duration.minute)
     output$activityPeriods_duration_median = median(activityPeriods$duration.minute)
     output$activityPeriods_duration_std = sd(activityPeriods$duration.minute)
     output$activity_count_in_activityPeriods_per_minute_avg = mean(activityPeriods$activityCounts.per.minute)
     output$activity_count_in_activityPeriods_per_minute_median = median(activityPeriods$activityCounts.per.minute)
     output$activity_count_in_activityPeriods_per_minute_std = sd(activityPeriods$activityCounts.per.minute)
